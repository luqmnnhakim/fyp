...
<body class="body-sales">
    ...
    <div class="sales-container">
        ...
        <button class="remove-btnSales" onclick="if(confirm('Adakah Anda Pasti Dengan Pilihan Anda?')) { window.location.href='removestaff.php?cid=<?= $value['adid']; ?>'; }">Remove</button>
